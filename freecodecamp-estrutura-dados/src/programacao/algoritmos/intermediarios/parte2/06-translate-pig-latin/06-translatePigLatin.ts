...
function translatePigLatinVariacaoSolucao1(str: any) {
...
function translatePigLatin1(str: any) {
...
function translatePigLatin2(str: any) {
  let pigLatin = "";
  let regex = /[aeiou]/gi;
...
//3ª solução do site.
function translatePigLatin3(str: any) {
...
//4ª solução do site.
function translatePigLatin4(str: string) {
  return str
    .replace(/^[aeiou]\w*/, "$&way")
